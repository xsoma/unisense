...
namespace hs {
	...
	_(watermark, "unisense cheat Alpha\nWelcome, %s\nSubscription ends in: %s"); // uni.beta \nWelcome, %s\nSubscription ends in: %s
	...
	// hwid
	_(unisense_pw_subs_check, "https://unisense.pw/subs_check"); // https://unisense.pw/subs_check
	...
	_(mat_fullbright, "mat_fullbright"); // mat_fullbright
	...
	_(fog_enable, "fog_enable"); // fog_enable
	_(fog_override, "fog_override"); // fog_override
	_(fog_color, "fog_color"); // fog_color
	_(fog_start, "fog_start"); // fog_start
	_(fog_end, "fog_end"); // fog_end
	_(fog_maxdensity, "fog_maxdensity"); // fog_maxdensity
	...
	_(is_Line_goes_through_smoke, "55 8B EC 83 EC 08 8B 15 ? ? ? ? 0F 57 C0"); //55 8B EC 83 EC 08 8B 15 ? ? ? ? 0F 57 C0
