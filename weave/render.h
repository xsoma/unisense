...
public:
	...
	void __stdcall arc(float x, float y, float radius, float min_angle, float max_angle, color_t col, float thickness);
...
namespace Drawing
{
	...
	extern void arc (float x, float y, float radius, float min_angle, float max_angle, color_t col, float thickness, ImDrawList* draw_list);
